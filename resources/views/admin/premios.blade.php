                    ...
                    <div class="card card-primary">
                        ...
                        <div class="col-span-12 sm:col-span-4">
                            ...
                            <label for="visibilidad" class="form-label">Visibilidad *</label>
                                <select class="form-control" name="visibilidad" id="visibilidad" onchange=visibilidad()>
                                    <option id="1" value='default'>Selecciona una opcion</option>
                                    <option id="2" value="{{0}}">Publico</option>
                                    <option id="3" value='{{1}}'>Privado</option>
                    
                                </select>
                            </div>
                            <div class="intro-y col-span-12 sm:col-span-6">
                                <label for="fechaInicio" class="form-label"> Fecha de Inicio</label>
                                <input id="fechaInicio" type="date" class="form-control @if(old('opc')=='1') @error('fechaInicio') is-invalid @enderror @endif" name="fechaInicio" required autocomplete="off" placeholder="Ingresa la fecha de inicio">
                                @error('fechaInicio')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="intro-y col-span-12 sm:col-span-6">
                                ...
                                <input id="fechaFin" type="date" class="form-control @if(old('opc')=='1') @error('fechaFin') is-invalid @enderror @endif" name="fechaFin" required autocomplete="off" placeholder="ingresa la fecha de fin">
                                @error('fechaFin')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
