                        ...
                        <div class="box py-0 xl:py-5 grid grid-cols-12 gap-0 divide-y xl:divide-y-0 divide-x divide-dashed divide-slate-200 dark:divide-white/5">
                            <div class="report-box__item py-5 xl:py-0 px-5 col-span-12 sm:col-span-6 xl:col-span-3">
                                <div class="report-box__content">
                                        ...
                                        <div class="ml-auto">
                                            @php
                                                ...
                                                if ($rendimiento->count() > 1) {
                                                    $diferencial = $rendimiento[1]->total_exp_sum - $rendimiento[2]->total_exp_sum;
                                                    if ($diferencial > 0) {
                                                        $color = 'text-success';
                                                        $arrow = 'arrow-up';
                                    ...
                                    <div class="text-2xl font-medium leading-7 mt-6">{{ $rendimiento[1]->total_exp_sum }}</div>
                    ...
                    <div class="intro-y box p-5 mt-4">
                        @foreach($prestadores as $prestador)
                            <div class="flex items-center mb-5 last:mb-0">
                                ...
                                <div class="ml-3 truncate pr-5">{{ $prestador->perfil }}</div>
                                <div class="ml-auto">{{ $prestador->experiencia }}</div>
                            </div>
                        @endforeach
                    </div>
                        ...
                        <div class="md:flex items-center">
                            <div class="mr-auto">
                                <div class="flex items-center">
                                    <div class="text-2xl font-medium">{{ $rendimiento[1]->total_exp_sum }}</div>
                                    @php
                                        $diferencial = 0;
                                        $color = 'text-gray-500';
                                        if ($rendimiento->count() > 1) {
