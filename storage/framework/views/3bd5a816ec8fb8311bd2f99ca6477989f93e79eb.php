                        ...
                        <div class="intro-x dropdown h-10">
                            <div class="h-full dropdown-toggle flex items-center" role="button" aria-expanded="false" data-tw-toggle="dropdown">
                                <div class="w-10 h-10 image-fit">
                                    <img alt="Usr" class="rounded-full border-2 border-slate-100 border-opacity-10 shadow-lg" src="<?php echo e(asset('build/assets/images/barrera.jpg')); ?>">
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GestionLAB\resources\views//newHomeP.blade.php ENDPATH**/ ?>