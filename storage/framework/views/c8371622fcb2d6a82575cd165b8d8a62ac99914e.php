        ...
        <?php endif; ?>
          ...
          <div class="col-md-9"> 
            ...
            <div class="profile-image d-flex justify-content-center overflow-hidden">
              ...
              <?php else: ?>
              <img src="<?php echo e(asset('build/assets/images/barrera.jpg')); ?>" alt="<?php echo e($user->name); ?>" width="150" height="150">
              <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts/prestador-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GestionLAB\resources\views/prestador/perfil_prestador.blade.php ENDPATH**/ ?>