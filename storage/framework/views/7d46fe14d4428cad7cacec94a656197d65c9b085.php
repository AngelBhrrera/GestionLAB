...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
    ...
    <!-- // end .section -->
    <div class = "section light-bg" id="caracteristicas"></div>
    <div class="section">
        <div class="container">
            <div class="section-title">
    ...
    <div class="section">
        <div class="container">
            <div class="section-title">
                <h3>Un día en el laboratorio ...</h3>
            </div>

            <div class="img-gallery owl-carousel owl-theme">

                <img src="build/assets/images/labMedia1.png" alt="image">
                <img src="build/assets/images/labMedia2.png" alt="image">
                <img src="build/assets/images/labMedia3.png" alt="image">
                <img src="build/assets/images/labMedia4.png" alt="image">
                <img src="build/assets/images/labMedia5.jpeg" alt="image" height="448" width="800">
            </div>
        </div>
    </div>
    <!-- // end .section -->
        ...
        <div class="container">
            ...
            <div class="testimonials owl-carousel">     
                <div class="testimonials-single">
                    <img src="build/assets/images/coordBonilla.jpg" alt="client.jgp" class="client-img">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="mb-2">                            
                                    <span class="ti-email mr-2"></span> <a class="mr-4" href="mailto:support@mobileapp.com">carlos.chavoya4676@alumnos.udg.mx</a>                            
                                </p>
                            </td>
                            <td>
                                <p class="mb-2">
                                ...
                                <p class="mb-2">                            
                                    <span class="ti-email mr-2"></span> <a class="mr-4" href="mailto:support@mobileapp.com">angel.barrera4326@alumnos.udg.mx</a>                            
                                </p>                            
                            </td>
                        </tr>
                    </tbody>
...
</html><?php /**PATH C:\laragon\www\GestionSSCFE\resources\views/landingPageTEMP.blade.php ENDPATH**/ ?>