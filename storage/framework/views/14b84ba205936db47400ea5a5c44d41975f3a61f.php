                    ...
                    <div class="intro-y box p-5 mt-4">
                        <div class="flex items-center mb-5 last:mb-0">
                            <div class="w-[1.15rem] h-[1.15rem] image-fit rounded-full overflow-hidden">
                                <img class="rounded-full !w-[140%] !h-[140%] -mt-[20%]" alt="Rocketman Tailwind HTML Admin Template" src="<?php echo e(asset('build/assets/images/united-states.svg')); ?>">
                            </div>
                        ...
                        <div class="flex items-center mb-5 last:mb-0">
                            <div class="w-[1.15rem] h-[1.15rem] image-fit rounded-full overflow-hidden">
                                <img class="rounded-full !w-[140%] !h-[140%] -mt-[20%]" alt="Rocketman Tailwind HTML Admin Template" src="<?php echo e(asset('build/assets/images/france.svg')); ?>">
                            </div>
                        ...
                        <div class="flex items-center mb-5 last:mb-0">
                            <div class="w-[1.15rem] h-[1.15rem] image-fit rounded-full overflow-hidden">
                                <img class="rounded-full !w-[140%] !h-[140%] -mt-[20%]" alt="Rocketman Tailwind HTML Admin Template" src="<?php echo e(asset('build/assets/images/spain.svg')); ?>">
                            </div>
                        ...
                        <div class="flex items-center mb-5 last:mb-0">
                            <div class="w-[1.15rem] h-[1.15rem] image-fit rounded-full overflow-hidden">
                                <img class="rounded-full !w-[140%] !h-[140%] -mt-[20%]" alt="Rocketman Tailwind HTML Admin Template" src="<?php echo e(asset('build/assets/images/united-kingdom.svg')); ?>">
                            </div>
                        ...
                        <div class="flex items-center mb-5 last:mb-0">
                            <div class="w-[1.15rem] h-[1.15rem] image-fit rounded-full overflow-hidden">
                                <img class="rounded-full !w-[140%] !h-[140%] -mt-[20%]" alt="Rocketman Tailwind HTML Admin Template" src="<?php echo e(asset('build/assets/images/india.svg')); ?>">
                            </div>
                        ...
                        <div class="flex items-center mb-5 last:mb-0">
                            <div class="w-[1.15rem] h-[1.15rem] image-fit rounded-full overflow-hidden">
                                <img class="rounded-full !w-[140%] !h-[140%] -mt-[20%]" alt="Rocketman Tailwind HTML Admin Template" src="<?php echo e(asset('build/assets/images/brazil.svg')); ?>">
                            </div>
                        ...
                        <div class="flex items-center mb-5 last:mb-0">
                            <div class="w-[1.15rem] h-[1.15rem] image-fit rounded-full overflow-hidden">
                                <img class="rounded-full !w-[140%] !h-[140%] -mt-[20%]" alt="Rocketman Tailwind HTML Admin Template" src="<?php echo e(asset('build/assets/images/switzerland.svg')); ?>">
                            </div>
                            ...
                            <div class="daily-report">
                                <div class="daily-report__statistic flex">
                                    ...
                                    <?php $__currentLoopData = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="w-full">
                                            <div class="text-slate-500 text-xs h-5"><?php echo e($month); ?></div>
                                                ...
                                                <?php for($week = 0; $week < 4; $week++): ?>
                                                    <div>
                                                        <?php $__currentLoopData = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div title="<?php echo e(rand(1, 50)); ?> sales on 2 Sep, 2021" class="daily-report__statistic__day tooltip w-full pt-[100%] mb-2 cursor-pointer zoom-in bg-primary <?php echo e(['bg-opacity-60', 'bg-opacity-40', 'bg-opacity-30', 'bg-opacity-20', 'bg-opacity-10'][rand(0, 4)]); ?>"></div>
                ...
                <div class="2xl:pl-6 grid grid-cols-12 gap-x-6 gap-y-8">
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-4 2xl:col-span-12">
                        ...
                        <div class="mt-4">
                            <div class="intro-x box p-5">
                                <div class="flex items-center">
                                    <img class="w-7 h-7" alt="Rocketman Tailwind HTML Admin Template" src="<?php echo e(asset('build/assets/images/chrome.png')); ?>">
                                    <div class="ml-4">Chrome</div>
                                    <div class="ml-auto">25%</div>
                                </div>
                                <div class="flex items-center mt-5">
                                    <img class="w-7 h-7" alt="Rocketman Tailwind HTML Admin Template" src="<?php echo e(asset('build/assets/images/edge.png')); ?>">
                                    <div class="ml-4">Microsoft Edge</div>
                                    <div class="ml-auto">5%</div>
                                </div>
                                <div class="flex items-center mt-5">
                                    <img class="w-7 h-7" alt="Rocketman Tailwind HTML Admin Template" src="<?php echo e(asset('build/assets/images/firefox.png')); ?>">
                                    <div class="ml-4">Firefox</div>
                                    <div class="ml-auto">45%</div>
                                </div>
                                <div class="flex items-center mt-5">
                                    <img class="w-7 h-7" alt="Rocketman Tailwind HTML Admin Template" src="<?php echo e(asset('build/assets/images/opera.png')); ?>">
                                    <div class="ml-4">Opera</div>
                                    <div class="ml-auto">2%</div>
                                </div>
                                <div class="flex items-center mt-5">
                                    <img class="w-7 h-7" alt="Rocketman Tailwind HTML Admin Template" src="<?php echo e(asset('build/assets/images/safari.png')); ?>">
                            ...
                            <?php $__currentLoopData = array_slice($fakers, 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="intro-x">
                                    <div class="box px-5 py-3 flex items-center zoom-in mb-3">
                                        <div class="mr-auto">
                                            <div class="font-medium"><?php echo e($faker['users'][0]['name']); ?></div>
                                            <div class="text-slate-500 text-xs mt-1"><?php echo e($faker['dates'][0]); ?></div>
                                        </div>
                                        <div class="<?php echo e($faker['true_false'][0] ? 'text-success' : 'text-danger'); ?>"><?php echo e($faker['true_false'][0] ? '+' : '-'); ?>$<?php echo e($faker['totals'][0]); ?></div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/main-layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> ?><?php /**PATH C:\laragon\www\GestionSSCFE\resources\views//newUI/dashboard2.blade.php ENDPATH**/ ?>