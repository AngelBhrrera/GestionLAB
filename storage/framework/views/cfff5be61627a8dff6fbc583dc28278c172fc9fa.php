...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
    ...
    <header class="" id="home">
        ...
        <div class="main-gallery owl-carousel owl-theme">
            <div class="img-holder mt-3"><img src="<?php echo e(asset('build/assets/images/imagenLat.jpg')); ?>" alt="lab" class="img-fluid"></div>
            <div class="img-holder mt-3"><img src="<?php echo e(asset('build/assets/images/imagenLab2.jpg')); ?>" alt="lab" class="img-fluid"></div>
            <div class="img-holder mt-3"><img src="<?php echo e(asset('build/assets/images/labMedia.jpg')); ?>" alt="image" class="img-fluid"></div>
            <div class="img-holder mt-3"><img src="<?php echo e(asset('build/assets/images/labMedia2.jpg')); ?>" alt="image" class="img-fluid"></div>
            <div class="img-holder mt-3"><img src="<?php echo e(asset('build/assets/images/labMedia3.jpg')); ?>" alt="image" class="img-fluid"></div>
            <div class="img-holder mt-3"><img src="<?php echo e(asset('build/assets/images/labMedia4.jpg')); ?>" alt="image" class="img-fluid"></div>
            <div class="img-holder mt-3"><img src="<?php echo e(asset('build/assets/images/labMedia6.jpg')); ?>" alt="image" class="img-fluid"></div>
            <div class="img-holder mt-3"><img src="<?php echo e(asset('build/assets/images/labMedia7.jpg')); ?>" alt="image" class="img-fluid"></div>
            <div class="img-holder mt-3"><img src="<?php echo e(asset('build/assets/images/labMedia8.jpg')); ?>" alt="image" class="img-fluid"></div>
                    ...
                    <div class="tab-pane fade show active" id="semanal">
                        <ul class="nav nav-tabs nav-justified" role="tablist">
                            ...
                            <li class="nav-item">
                                ...
                                <p class="nav-link"><?php echo e($users[0]->name); ?></p>
                                <p class="nav-link"><?php echo e($users[1]->name); ?></p>
                                <p class="nav-link"><?php echo e($users[2]->name); ?></p>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link active">Experiecia</a>
                                <p class="nav-link"><?php echo e($users[0]->experiencia); ?></p>
                                <p class="nav-link"><?php echo e($users[1]->experiencia); ?></p>
                                <p class="nav-link"><?php echo e($users[2]->experiencia); ?></p>
                            </li>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <p class="light-font mb-1 text-center">Derechos reservados ©2021 - 2023. Universidad de Guadalajara.
                        ...
                        <a class="mr-4 mb-5" href="<?php echo e(route('devTeam')); ?>">Equipo de desarrollo</a>
                    </p>
                </div>
...
<?php /**PATH C:\laragon\www\GestionLAB\resources\views/landingPageTEMP.blade.php ENDPATH**/ ?>