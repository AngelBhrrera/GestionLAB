    ...
    <div class="w-full min-h-screen md:p-10 flex items-center justify-center">
        ...
        <div class="intro-y box py-30  mt-">
            ...
            <div style="display: flex;">
                <img class="mx-auto my-auto" alt="Inventores" width="80px" height="80px" src="<?php echo e(asset('build/assets/logosinventores/InventoresLogoHDWhiteborder.png')); ?>">
            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                            ...
                            <a id="btn-reg" class="navbar-brand" style= "display:none">
                                <button  type="submit" class="btn btn-primary w-24 ml-2"  style="background-color:#1B1C80; border-color:#006646"><?php echo e(__('Registrar')); ?></button>
                            </a>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/login-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GestionLAB\resources\views/auth/register.blade.php ENDPATH**/ ?>