            ...
            <div class="box py-0 xl:py-5 grid grid-cols-12 gap-0 divide-y xl:divide-y-0 divide-x divide-dashed divide-slate-200 dark:divide-white/5">
                ...
                <div class="report-box__item py-5 xl:py-0 px-5 col-span-12 sm:col-span-6 xl:col-span-3">
                    <div class="report-box__content">
                        ...
                        <div class="text-2xl font-medium leading-7 mt-6"><?php echo e($horasTotales); ?></div>
                ...
                <div class="report-box__item py-5 xl:py-0 px-5 sm:!border-t-0 col-span-12 sm:col-span-6 xl:col-span-3">
                    <div class="report-box__content">
                        ...
                        <div class="text-2xl font-medium leading-7 mt-6"><?php echo e($horasAutorizadas); ?></div>
                ...
                <div class="report-box__item py-5 xl:py-0 px-5 col-span-12 sm:col-span-6 xl:col-span-3">
                    <div class="report-box__content">
                        ...
                        <div class="text-2xl font-medium leading-7 mt-6"><?php echo e($horasPendientes); ?></div>
                ...
                <div class="report-box__item py-5 xl:py-0 px-5 col-span-12 sm:col-span-6 xl:col-span-3">
                    ...
                    <div class="text-2xl font-medium leading-7 mt-6"><?php echo e($horasRestantes); ?></div>
                            ...
                            <td class="w-40">
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img alt="SS" class="tooltip rounded-full" src="<?php echo e(asset('build/assets/images/image-6')); ?>" title="Uploaded at 2023">
                                    </div>
                                </div>
                            </td>
                            <td>
...
<?php echo $__env->make('layouts/prestador-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GestionLAB\resources\views/prestador/newHomeP.blade.php ENDPATH**/ ?>