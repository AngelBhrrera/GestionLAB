...
<html lang="en">
    ...
    <head>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" id="formactivar" action="<?php echo e(route('api.activar')); ?>">
                            ...
                            <?php echo csrf_field(); ?>
                            <p id="txtmodalActivar">¿Desea activar este prestador?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        ...
        <!-- Modal informacion y aceptar proyectos. Modal Actividades-->
...
</html><?php /**PATH C:\laragon\www\GestionLAB\resources\views/table.blade.php ENDPATH**/ ?>