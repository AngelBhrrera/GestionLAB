        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form  method="POST" id="formeliminar" action="<?php echo e(route('api.eliminardiafestivo')); ?>">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title"><?php echo e('Nueva fecha'); ?></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('api.guardardiasfestivos')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="form-group row">
                                <label for="descripcion" class="col-md-4 col-form-label text-md-right">Fecha</label>
                                <div class="col-md-6">
                                    <div class="input-group date" id="datetimepicker" data-target-input="nearest">
                                        <input name="fecha" type="text" class="form-control datetimepicker-input" data-toggle="datetimepicker" data-target="#datetimepicker" autocomplete="off" value="<?php echo e(isset($actm[0]->fecha) ? $actm[0]->fecha : old('datepiker')); ?>"/>
...
<?php /**PATH C:\laragon\www\GestionSSCFE\resources\views/tablecalendario.blade.php ENDPATH**/ ?>