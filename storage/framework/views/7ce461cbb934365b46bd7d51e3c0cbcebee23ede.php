            ...
            <div class="scrollable">
                <ul class="scrollable__content">
                    <li class="side-nav__devider mb-4">MENU</li>
                        <li>
                            ...
                            <ul class="">
                                ...
                                <li>
                                    <a href="<?php echo e(route('horas')); ?>" class="side-menu">
                                        <div class="side-menu__icon"> <i data-lucide="clock"></i> </div>
                                        <div class="side-menu__title">  Registro de horas </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('medallas')); ?>" class="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="">
                            <li>
                                <a href="<?php echo e(route('horario')); ?>" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="clock"></i> </div>
...
<?php echo $__env->make('../layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GestionLAB\resources\views/layouts/prestador-layout.blade.php ENDPATH**/ ?>