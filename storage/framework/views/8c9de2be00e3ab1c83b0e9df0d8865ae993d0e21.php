...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('img/recursos/logo.png')); ?>"/>
</head>
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <img src="<?php echo e(asset('img/recursos/Logo-CFE.webp')); ?>" alt="Logo" class="mx-auto d-block" style="max-width: 120px;">
...
<?php /**PATH C:\laragon\www\GestionLAB\resources\views/layouts/app.blade.php ENDPATH**/ ?>