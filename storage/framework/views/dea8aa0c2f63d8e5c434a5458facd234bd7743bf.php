        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form  method="POST" id="formeliminar" action="<?php echo e(route('api.eliminarhorario')); ?>">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title"><?php echo e('Nueva horario'); ?></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('api.guardarhorario')); ?>">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\GestionSSCFE\resources\views/tableHorario.blade.php ENDPATH**/ ?>