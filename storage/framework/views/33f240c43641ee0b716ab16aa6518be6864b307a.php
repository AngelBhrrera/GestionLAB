...
unset($__errorArgs, $__bag); ?> <?php endif; ?>" name="correo" required autocomplete="correo" placeholder="Correo">
...
unset($__errorArgs, $__bag); ?> <?php endif; ?>" name="telefono" required autocomplete="telefono" placeholder="Telefono">
...
unset($__errorArgs, $__bag); ?> <?php endif; ?>" name="carrera" required autocomplete="carrera" placeholder="Carrera">
