        ...
        <div class="w-full min-h-screen p-5 md:p-20 flex items-center justify-center">
            <div class="w-96 intro-y">
                <div style="display: flex;">
                    <img class="mx-auto w-72" alt="CFE" src="<?php echo e(asset('build/assets/images/cfe.svg')); ?>">
                    <img class="mx-auto w-40" src="<?php echo e(asset('build/assets/images/logo-UDG.png')); ?>">
                </div>
                <div class="box px-5 py-8 mt-10 max-w-[450px] relative before:content-[''] before:z-[-1] before:w-[95%] before:h-full before:bg-slate-200 before:border before:border-slate-200 before:-mt-5 before:absolute before:rounded-lg before:mx-auto before:inset-x-0 before:dark:bg-darkmode-600/70 before:dark:border-darkmode-500/60">
                    ...
                    <form method="POST" id="login-form">
                        ...
                        <div class="mt-5 xl:mt-8 text-center xl:text-left">                        
                            <button id="btn-login" type="submit" class="btn btn-primary w-full xl:mr-3 " style="background-color:#00724E; border-color:#006646">Iniciar Sesion</button>
                        </div>
                    </form>
...
<?php echo $__env->make('../layouts/login-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GestionSSCFE\resources\views/auth/login.blade.php ENDPATH**/ ?>