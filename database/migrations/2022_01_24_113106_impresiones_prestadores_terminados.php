...
class ImpresionesPrestadoresterminados extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        \DB::statement("
        CREATE VIEW `impresiones_prestadores_terminados`
        AS SELECT
        ...
        `prestadores_impresiones`.`correo_prestador` AS `correo_prestador`,
        ...
        FROM `prestadores_impresiones` WHERE (`prestadores_impresiones`.`status_impresion` = 'completado') ;
